            ...
            Container(
              height: SizePage.height/5,
                child: Container(alignment: Alignment.centerLeft,
                    ...
                    child:Text(textRegistration, style: Montserrat(style:Bold,color:Blue, size: 30))
                ),
            ),
            Container(
                        ...
                        Container(height: 112,
                            child: Column(children:[
                              Container(width: double.infinity,
                                ...
                                child: Text(textNameSurname, style: Montserrat(color:Blue,style: SemiBold)),
                              ),
                    ...
                    TextButton(onPressed: (){
                      Validation();
                        ...
                        child: Container(width: SizePage.width-SizePage.width/15*2,
                            ...
                            child: Center(child: Text('Зарегестрироваться', style: Montserrat(style: SemiBold,size: 19)),)
                        )
                    ),
