...
class MyDropdownFormField<T> extends StatefulWidget {
  ...
  /// The list may be offline, or remote back-end from server.
  ...
  @override
  MyDropdownFormFieldldState createState() => MyDropdownFormFieldldState<T>();
}

class MyDropdownFormFieldldState<T> extends State<MyDropdownFormField>
  ...
  MyDropdownFormFieldldState() : super() {}
