                            ...
                            TextFormField(
                                ...
                                decoration: TextFieldDecoration(
                                        ...
                                        prefixIcon: PrefixIconTextField(
                                            color: const Color(0xFFffaf5a), icon: iconMenuProfile))
                                    .inputDecoration),
                            errorText: true,
                            error: errorName,
                          )
      ...
      Positioned(
        child: isLoading
            ? Container(
                child: const Center(
                    child:
                        CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Blue))),
  ...
  void Validation() async {
    ...
    if (countError == 0) {
      ...
      if (user == null) {
        ...
        showTopSnackBar(
            context, CustomSnackBar.error(message: 'починить', textStyle: Montserrat(size: 15)));
      } else {
