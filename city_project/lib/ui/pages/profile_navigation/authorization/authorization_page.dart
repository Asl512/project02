            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Container(
                  ...
                  child: Column(children: [
                    Container(
                        padding: EdgeInsets.symmetric(horizontal: sizePage.width / 7, vertical: 40),
                    ...
                    Column(children: [
                      Row(
                          ...
                          children: [
                            ...
                            TextButton(
                                child:
                                    Text("Напомнить", style: Montserrat(size: 17, style: SemiBold)),
    ...
    if (countError == 0) {
      ...
      if (user == null) {
        ...
        Navigator.pushAndRemoveUntil(
          context,
          MaterialPageRoute(builder: (_) => const Navigation(index: 3)),
          (route) => false,
        );
      }
