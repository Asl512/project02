...
class _AddExcursionState extends State<AddExcursion> {
  ...
  void firebaseConnection(String? idUser) async {
    if (this.dataCityDB.isEmpty) {
      ...
      if (!this.user.first["guidePermit"]) {
        showTopSnackBar(
            ...
            CustomSnackBar.error(
                message: "Ошибка: Вы не являетесь гидом", textStyle: Montserrat(size: 15)));
        Navigator.pushAndRemoveUntil(
            context, MaterialPageRoute(builder: (_) => Navigation(index: 3)), (route) => false);
      }

      await FirebaseFirestore.instance
          .collection('excursion_navigation')
          .orderBy('name')
          .get()
          .then((snapshot) => {dataCityDB = snapshot.docs});
      ...
      await FirebaseFirestore.instance
          ...
          .orderBy('name')
          .get()
          .then((snapshot) => {dataTagsDB = snapshot.docs});
  ...
  Widget build(BuildContext context) {
    ...
    if (type.isEmpty) {
      String typeName;
      if (widget.typeExcursion[0]['name'].length > 24)
        typeName = widget.typeExcursion[0]['name'].split('').sublist(0, 24).join() + '...';
      else
        typeName = widget.typeExcursion[0]['name'];
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            leading: Container(),
            backgroundColor: Grey,
            flexibleSpace: Stack(alignment: Alignment.topLeft, children: [
              Container(
                  margin: EdgeInsets.only(
                      top: MediaQuery.of(context).size.height / 25,
                      left: MediaQuery.of(context).size.width / 6),
                  child: Text("Добавить экскурсию",
                      style: Montserrat(color: Blue, size: 28, style: SemiBold))),
              ButtonBack()
            ]),
            forceElevated: true,
            floating: true,
                  ...
                  TextFieldWithShadow(
                    MyDropdownFormField<Map<String, dynamic>>(
                        ...
                        decoration: TextFieldDecoration(
                          prefixIcon: PrefixIconTextField(color: Color(0xFF546eff), icon: iconCity),
                        ...
                        displayItemFn: (dynamic item) => city.isEmpty
                            ? Text(
                                'Тюмень',
                  ...
                  DropdownButtonHideUnderline(
                    child: DropdownButton2(
                      ...
                      hint: Row(
                        children: [
                          PrefixIconTextField(
                              color: Color(0xFF42cec0), icon: Center(child: iconTypeExcursion)),
                      ...
                      onChanged: (value) {
                        ...
                        setState(() {
                          this.type = {"name": type[0], "id": int.parse(type[1])};
                        });
                      },
                    ),
                  ),
                  ...
                  TextFieldWithShadow(
                    TextFormField(
                        ...
                        decoration: TextFieldDecoration(
                          ...
                          prefixIcon:
                              PrefixIconTextField(color: Color(0xFFff5454), icon: iconLocation),
                        ).inputDecoration),
                  ...
                  TextFieldWithShadow(
                    TextFormField(
                        ...
                        decoration: TextFieldDecoration(
                          ...
                          prefixIcon:
                              PrefixIconTextField(color: Color(0xFF4485e6), icon: iconSizer),
                        ).inputDecoration),
                  ...
                  TextFieldWithShadow(
                    MyDropdownFormField<Map<String, dynamic>>(
                        ...
                        onChanged: (dynamic item) {
                          setState(() {
                            tags.add(item);
                            rolesTags.removeWhere((element) => element == item);
                          });
                        },
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Wrap(
                          crossAxisAlignment: WrapCrossAlignment.center, children: PhotosList())),
                  ...
                  children: [
                    TextButton(
                        ...
                        child: Container(
                            ...
                            height: 50,
                            decoration: BoxDecoration(
                                color: Blue, borderRadius: BorderRadius.all(Radius.circular(500))),
                            child: Center(
                              child: Text("Добавить", style: Montserrat(style: SemiBold, size: 19)),
                            ))),
  ...
  void Validation() {
    ...
    if (this.groupSize == null) {
      ...
      lines++;
    } else if (this.groupSize! < 4) {
      //проверка на тип индивид. = 1, группавая = 4
      setState(
          () => groupSizeError = [true, "Максимальный размер группы должен быть больше 5 человек"]);
    ...
    if (errorText == "")
      showTopSnackBar(
          ...
          CustomSnackBar.success(
              message: "Ваша экскурсия была добавлена в модерацию",
              textStyle: Montserrat(size: 15)));
    else
