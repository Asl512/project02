...
class ControllerNewExcursion {
  ...
  final TextEditingController sizeGroup = TextEditingController();
  final TextEditingController standardPrice = TextEditingController();
  ...
  final TextEditingController organizationalDetails = TextEditingController();
  final TextEditingController addServices = TextEditingController();
