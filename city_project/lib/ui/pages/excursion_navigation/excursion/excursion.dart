            ...
            flexibleSpace: Stack(alignment: AlignmentDirectional.topStart,
              children: [
                Stack(alignment: AlignmentDirectional.bottomEnd,
                  children: [
                    Stack(children: [
                      Image.network("https://visittyumen.ru/upload/iblock/b25/detail.JPG",
                        fit: BoxFit.cover,
                      ...
                      Container(alignment: Alignment.centerLeft,
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Flexible(child: Text("Название экскурсии".toString().toUpperCase(),
                        ...
                        children:[
                          Container(padding: EdgeInsets.symmetric(horizontal: 15),
                              ...
                              child: Stack(children: [
                                PhotoAuthor("https://i.pinimg.com/736x/b4/72/a1/b472a1234f0fad2a6bd45750c14e7bec.jpg"),
                                GuideCheck(true)
                              ])),
                          Container(color: Colors.black.withOpacity(0.5),height: 50,
                              padding: EdgeInsets.only(right: 15),
                              alignment: Alignment.center,
                              child: Text("Анна Иванова",style: Montserrat(size: 15,style: SemiBold))
                          )
                        ])
                  ],
                ),
      ...
      return Container(padding: EdgeInsets.symmetric(horizontal: 20,vertical: 5),
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.center,
                  ...
                  children: [
                    ...
                    TextButton(onPressed:(){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => RewiewPage(null)));
                    },
                        child: Row(crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            Text(0.toString() + " отзывов",style: Montserrat(color: Color(0xFFF48494a),size: 16,style: Bold)),
                ...
                ///ОПИСАНИЕ
                Text("Описание экскурсии", style: Montserrat(color: Blue,size: 15)),
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Container(child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                    children: [
                                      Text("Индивидуальная", style: Montserrat(color: Blue,size: 16,style: Bold)),
                                      Text(3.toString() + " часа", style: Montserrat(color: Blue,size: 16))
                                    ]),
                                  ...
                                  children: [
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      ...
                                      children: [
                                        ...
                                        Container(child: Text("Пешком, на автобусе", style: Montserrat(color: Blue,size: 14,)),
                                    ...
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      ...
                                      children: [
                                        ...
                                        Container(child: Text('до ' + 4.toString() + " человек", style: Montserrat(color: Blue,size: 14,)),
                                            width: MediaQuery.of(context).size.width/2-40),
                                      ],
                                    ),
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      ...
                                      children: [
                                        ...
                                        Container(child: Text("13:00", style: Montserrat(color: Blue,size: 14,)),
                                            width: MediaQuery.of(context).size.width/2-40),
                                      ],
                                    ),
                                    Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      ...
                                      children: [
                                        ...
                                        Container(child: Text("Улица Пушкина 4", style: Montserrat(color: Blue,size: 14,)),
                                            width: MediaQuery.of(context).size.width/2-40),
                                      ],
                                    )
                                  ],
                                ...
                                RichText(text: TextSpan(
                                    children: [
                                      TextSpan(text: "₽ " + 1200.toString(), style: Montserrat(style: Bold,size: 17, color:Blue)),
