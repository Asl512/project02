                            ...
                            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children:[
                                ...
                                TextButton(
                                  ...
                                  onPressed: ()
                                  {
                                   Navigator.pushNamed(context, '/recoveryOne');
                                  },
                                )
                              ]
                            ),
      ...
      if(check == true)
        {
          ...
          if(index == -1)
            {
              errorEmail[0] = true;
              errorEmail[1] = 'Данного пользователя не существует';
            }
          else if(dataUser[index][2] != password)
            {
              errorPassword[0] = true;
              errorPassword[1] = 'Вы ввели не правильный пароль';
            }
          else
            {
              auth = index;
