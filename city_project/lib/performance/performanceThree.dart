...
class PerfomanceThree extends StatefulWidget
{
  const PerfomanceThree({Key? key}) : super(key: key);

  @override
  State<PerfomanceThree> createState() => _PerfomanceThreeState();
}

class _PerfomanceThreeState extends State<PerfomanceThree>
{
            ...
            children: [
              Container(
                decoration: BoxDecoration(image: DecorationImage(fit: BoxFit.cover,
                  image: AssetImage(imgPerformanceThree),
                )),
              ),
          ...
          Column(mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
              Container(padding: EdgeInsets.fromLTRB(30, 90, 30, 0),
                ...
                child: Text(textPerfomanceThree,style: Montserrat(style: SemiBold, size: 24,heigth: 1.7),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                      children:[
                        ...
                        Container(margin: EdgeInsets.only(left: 40),
                            ...
                            {
                              Navigator.pushNamed(context, '/perfomanceFour');
                            },
