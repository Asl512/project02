...
class RecoveryOne extends StatefulWidget
{
  const RecoveryOne({Key? key}) : super(key: key);

  @override
  State<RecoveryOne> createState() => _RecoveryOneState();
}

class _RecoveryOneState extends State<RecoveryOne> {
                ...
                Flexible(flex: 2,
                    ...
                    child: Column(children:[
                      Container(width: double.infinity,
                        ...
                        child: Text(textInstructionRecoveryOne, style: Montserrat(color:Blue)),
                      ),
                        ...
                        children: [
                          ...
                          Container(padding: EdgeInsets.only(left: 106,right: 106,bottom: 100),
                              child:TextButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    Navigator.pushNamed(context, '/recoveryTwo');
