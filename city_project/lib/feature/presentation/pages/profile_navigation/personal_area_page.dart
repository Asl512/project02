...
import 'package:lan_code/feature/presentation/pages/profile_navigation/widgets/button_social_network_widget.dart';
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Stack(
                            children: [
                              PhotoUserWidget((user?.photo)??"null",size: MediaQuery.of(context).size.width/7),
                              VerifiedUserWidget(
                                  (user?.verified)??false,
                        ...
                        Container(
                            ...
                            child: Column(
                                ...
                                children:[
                                  ...
                                  ((user?.verified)??false)?Text('Личность подтверждена', style: Montserrat(color: Blue, size: 14)):
                                  RichText(
                                      text: TextSpan(
                                          text: "Подтвердить личность", style: Montserrat(style: SemiBold,size: 14, color:Red),
...
class ShowWeContacts extends StatelessWidget {
            ...
            child: Column(
                children: [
                  ...
                  Container(
                      ...
                      child: Text(
                          "Для решения вопросов, можете связаться с нами лично",
                          style: Montserrat(size: 14,color: White),
  ...
  void launchURL(String url,context) async {
      try{
        ...
        showTopSnackBar(
            context,
            CustomSnackBar.error(message:e.toString(),textStyle: Montserrat(size: 15,color: White),lines: 4,)
        );
      }
  }
}